...
const MembershipCard: React.FC<MembershipCardProps> = ({
  ...
  const { updateMembership } = useMemberContext(); // ✅ Add at top with deleteMembership
...
const handleSave = async () => {
  ...
  const error = await updateMembership(updatedMembership); // ✅ Call Supabase update
  ...
  toast.success('Membership plan updated');
  if (onEdit) onEdit(updatedMembership); // Still call onEdit to inform parent
  setIsEditing(false);
};
